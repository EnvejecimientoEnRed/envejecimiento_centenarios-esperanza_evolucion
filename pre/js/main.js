...
let dataSource = 'https://raw.githubusercontent.com/EnvejecimientoEnRed/envejecimiento_centenarios-esperanza_evolucion/main/data/evolucion_supervivientes.csv';
...
function initChart() {
    ...
    d3.text(dataSource, function (error, data) {
        ...
        line = d3.line()
            .x(d => x_c(+d.Periodo))
            .y(d => y_c(+d.esperanza_total.replace(',','.')))
        ...
        chart.selectAll('circles')
            ...
            .attr("cy", function(d) { return y_c(+d.esperanza_total.replace(',','.')); })
